...
<head>
    ...
    <title>APPSPREM | Dream E-Commerce</title>
    <link rel="stylesheet" href="<?php echo url_dasar()?>/css/styles.css">
    <link rel="icon" type="image/png" href="favicon.png"/>
</head>
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar()?>'>appsprem</a></div>
            <div class="menu">
                <ul>
