...
if(isset($_POST['login'])){
    ...
    if($email == '' or $password == ''){
        $err .= "<li>Silakan masukkan semua kolom yang tersedia</li>";
    }else{
        ...
        if($r1['password'] != md5($password) && $n1 >0 && $r1['status'] == '1'){
            $err .= "<li>Email atau Password tidak sesuai</li>";
        }
...
<form action="" method="POST">
    <table>
        ...
        <tr>
            <td></td>
            <td class="label">Lupa Password ? <a href='<?php echo url_dasar()?>/lupa_password.php'>Silahkan Reset</a></td>
        </tr>
        <tr>
            <td></td>
    ...
    <p>Belum punya akun ? <a href='<?php echo url_dasar()?>/pendaftaran.php'>Silahkan Register</a></p>
</form>